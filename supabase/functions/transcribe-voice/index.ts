    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are writing notes AS a sales rep — first-person field notes, not a description of what someone said.
...
Extract: prospect details, pain points, budget signals, timeline, next steps, and any other relevant sales context.`,
          },
          {
            role: "user",
            content: [
              { type: "text", text: "Extract all key information from this voice note into structured bullet points. Write as direct first-person sales notes — never narrate or describe what the speaker said." },
              {
                type: "input_audio",
                input_audio: {
                  data: audioBase64,
        ...
        tools: [
          {
            ...
            function: {
              ...
              parameters: {
                type: "object",
                properties: {
                  transcription: { type: "string", description: "Bullet-point notes in English only. Each bullet is a direct factual statement written as the sales rep. No prose, no paragraphs, no third-person narration. NEVER start bullets with 'The speaker', 'The rep', 'The user'. Example: • Met VP Sales at TechCorp • Pain point: manual lead entry taking 3 hrs/event • Budget: confirmed Q2 • Timeline: wants demo within 2 weeks • Next step: send case study" },
                  ...
                  summary: { type: "string", description: "Brief 1-2 sentence summary in English. Write as first-person sales notes, NEVER as 'The speaker said...'" },
                },
    ...
    // Post-process: strip any narration that slipped through the prompt
