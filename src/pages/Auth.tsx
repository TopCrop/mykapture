      ...
      >
        ...
        {view === "forgot" ? (
          <>
            ...
            <button onClick={() => setView("login")} className="flex items-center justify-center gap-1 w-full text-xs font-medium text-primary hover:underline">
          ...
          <>
            ...
            <p className="text-center text-xs text-muted-foreground">
              ...
              <button onClick={() => setView(view === "login" ? "signup" : "login")} className="font-medium text-primary hover:underline">
